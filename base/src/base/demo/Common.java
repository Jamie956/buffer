...
public class Common {
	...
	public void stringDemo(){
		...
		System.out.println(String.format("Hello %d World", 123));// Hello 123 World
		System.out.printf("Hello %d World\n", 456);// Hello 456 World
		System.out.println(Arrays.toString("hello".getBytes()));// [104, 101, 108, 108, 111]
		char[] c = new char[8];
		"hello".getChars(1, 4, c, 3);// (int srcBegin, int srcEnd, char[] dst, int dstBegin)
		System.out.println(Arrays.toString(c));// [?,?,?,e,1,1,?,?]
		System.out.println("helloworld".replace("o", "*"));// hell*w*rld
		System.out.println(Arrays.toString("tom,18,男,美国".split(",")));// [tom, 18, 男, 美国]
		System.out.println(Arrays.toString("123abc456def".split("")));// [1, 2, 3, a, b, c, 4, 5, 6, d, e, f]
		...
		System.out.println(Arrays.toString("abc虾米123".toCharArray()));// [a, b, c, 虾, 米, 1, 2, 3]
